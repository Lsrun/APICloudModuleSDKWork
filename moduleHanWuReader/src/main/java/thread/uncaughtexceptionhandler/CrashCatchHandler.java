...
public class CrashCatchHandler implements Thread.UncaughtExceptionHandler {
    ...
    /**
     * 初始化,注册Context对象, 获取系统默认的UncaughtException处理器, 设置该CrashCatchHandler为程序的默认处理器
     *
     * @param ctx
     */
